/*global $:true, Audica:true, TAFFY:true, escape:true, unescape:true, alert:true, console:true*/
(function (window) {
  "use strict";
  /**
   * @namespace
  ...
  window.AUDICA = function () {
     ...
     * TODO find a better solution by using the {@link historyDb}
     * @type {Array}
     * @private
     */
    var _songHistory = [];
    ...
    this.View = {
      ...
      applyCoverArtStyle:function () {
        ...
        Audica.Dom.coverArt[0].width = Audica.Dom.documentHeight * 0.6;
    ...
    this.collectSongs = function (songList, backendId, timestamp) {
      var i = 0, song, length = songList.length;
      for (i; i < length; i++) {
        song = songList[i];
