...
(function (window) {
  ...
  window.Subsonic = function() {
    ...
    function _searchForSongs(timestamp, collectErrors, collectProgress) { //TODO collectErrors, collectProgress
      var url = JSON.parse(localStorage.serverUrl) + "/search.view?u=" + JSON.parse(localStorage.authentication_login) + "&p=" + JSON.parse(localStorage.authentication_password) + "&v=1.2.0&c=chrome&count=100000&any=";
