/*global document:true, $:true, Scrobbler:true, alert:true, hex_md5*/
...
(function(document, Audica) {
  ...
  function saveLogin() {
    ...
    localStorage.setItem('authentication_login', JSON.stringify(login));
  }

  function savePassword() {
    var password = $('#passwordBox').val();
    localStorage.setItem('authentication_password', JSON.stringify(password));
  }
  ...
  function fill() {
    if (localStorage.getItem('authentication_password')) {
    ...
    if (localStorage.getItem('authentication_login')) {
    ...
    var gracenoteClientId = localStorage.getItem('gracenoteClientId');
    var gracenoteWepApiId = localStorage.getItem('gracenoteWepApiId');
    ...
    var lastFmLogin = localStorage.getItem('audica_lastfm_login');
  ...
  $(document).on('ready', function() {
    ...
    $('#retreiveGracenoteMoodData').on('click', function() {
      Audica.plugins.gracenote.init();
      Audica.plugins.gracenote.collectData();
    });
